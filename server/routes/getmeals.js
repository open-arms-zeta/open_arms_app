...
router.get('/mealExtras', function(req,res){
    ...
    pg.connect(connectionString, function (err, client) {
        var query = client.query("SELECT meals.meal_id, meals.entree, meals.side_1, meals.side_2, meals.status, categories.category_name, allergens.allergen_name, allergenspecific.specific_name\
        FROM meals\
